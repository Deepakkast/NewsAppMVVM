...
import kotlinx.android.synthetic.main.fragment_search_news.paginationProgressBarSe
...
class SearchNewsFragment :Fragment(R.layout.fragment_search_news) {
    ...
    private fun hideProgressBar() {
        paginationProgressBarSe.visibility  = View.INVISIBLE
        isLoading = false
    }

    private fun showProgressBar() {
        paginationProgressBarSe.visibility  = View.VISIBLE
        isLoading = true
    }
